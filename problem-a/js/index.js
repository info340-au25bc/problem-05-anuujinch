...
let indexOfCool = motto.indexOf("cool") !== -1;
console.log(indexOfCool);
...
var smotto = motto.replace("iSchool", "Information School");
motto = smotto;
console.log(motto);
...
var ratio = (motto.length / mottoLength) * 100;
...
var medianValue = sortedNumbers[medianIndex];
