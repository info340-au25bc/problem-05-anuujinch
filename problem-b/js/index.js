...
// This twelveString variable results in "84" because the + operator
// concatenates strings when one of the operands is a string.
...
console.log(compoundInterest(1000, 0.05, 10)); 
